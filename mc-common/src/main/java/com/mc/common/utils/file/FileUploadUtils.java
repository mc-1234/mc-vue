...
import com.mc.common.exception.file.FileNameLengthLimitExceededException;
import com.mc.common.exception.file.FileSizeLimitExceededException;
import com.mc.common.exception.file.InvalidExtensionException;
...
import static com.mc.common.config.MinioConfig.getBucketName;
...
public class FileUploadUtils
{
     ...
     * 默认上传的地址
     */
    private static String defaultBaseDir = MCConfig.getProfile();
    ...
    {
        int dirLastIndex = MCConfig.getProfile().length() + 1;
